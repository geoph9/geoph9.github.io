...
- [**KaTeX support**](@/publications/markdown.md#katex). Enabled by setting `katex = true` (274 KB).
- [**One-click copy of code blocks**](@/publications/markdown.md#code-block). Enabled by setting `copy_button = true`. (~700 bytes)
- [**Footnote backlinks**](@/publications/markdown.md#1). Enabled by setting `footnote_backlinks = true` (~500 bytes).
